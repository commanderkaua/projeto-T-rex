...
function pontuacao(){
  pontos=pontos+round(getFrameRate()/60);
...
function reiniciar(){
pontos = 0;
grupocactos.setVelocityXEach(-(4+3*pontos/1000));
gruponuvens.setVelocityXEach(-2);
estado = JOGANDO;
